    ...
    <div className="min-h-screen flex items-center justify-center px-4 pt-20 pb-10">
      ...
      >
        ...
        <div className="bg-linear-to-br from-white/8 to-white/3 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8">
          {/* OAuth providers */}
          <div>
            <p className="text-sm text-indigo-300 text-center mb-5">{m.login.continueWith}</p>
            <div className="space-y-3">
              <a
                href="/auth/google"
                className="flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl py-3 text-sm font-medium text-white transition-all hover:scale-[1.02]"
              >
